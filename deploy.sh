...
# ssh to GCP
gcloud compute --project "stockeeper-210714" ssh --zone "asia-east1-b" "stockeeper-init" --command "SHA=\"latest\" docker stack deploy --with-registry-auth -c docker-compose.test.yml stockeeper"